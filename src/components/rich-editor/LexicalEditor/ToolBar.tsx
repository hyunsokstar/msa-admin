...
import IDialogButtonForQuestionFromCurrentTextForLexicalEditor from "./ai/IDialogButtonForQuestionFromCurrentTextForLexicalEditor";
    ...
    return (
        <div className="p-2 border-b bg-gray-100 flex flex-col gap-2">
            ...
            <div className="flex items-center space-x-3">
                ...
                {/* AI 질문 버튼 추가 */}
                <div className="ml-3">
                    <IDialogButtonForQuestionFromCurrentTextForLexicalEditor
