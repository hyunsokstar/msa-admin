...
import { apiForUpdateArchivedTestItemRefVideo } from '@/api/apiForTestItemsArchive';
 ...
 */
export const useApiForUpdateArchivedTestItemRefVideo = () => {
    ...
    return useMutation({
        mutationFn: async ({ itemId, videoUrl }: {
            ...
            const result = await apiForUpdateArchivedTestItemRefVideo(itemId, videoUrl);
