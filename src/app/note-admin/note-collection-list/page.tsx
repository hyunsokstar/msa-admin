...
import { ITableForNoteListForSelectedCollectionWithDnd } from './_comp/ITableForNoteListForSelectedCollectionWithDnd';
...
const NoteCollectionListPage = () => {
  ...
  console.log('NoteCollectionListPage data:', data);
