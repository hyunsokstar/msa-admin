...
import { useApiForUpdateArchivedTestItemRefVideo } from '@/hook/useApiForUpdateArchivedTestItemRefVideo';
...
const IDialogButtonForRefVideoForArchivedTestItem: React.FC<IDialogButtonForRefVideoForTestItemProps> = ({
    testItemId,
    targetId,
    videoUrl,
    onClick,
    ...
    const updateVideoMutation = useApiForUpdateArchivedTestItemRefVideo();
...
export default IDialogButtonForRefVideoForArchivedTestItem;