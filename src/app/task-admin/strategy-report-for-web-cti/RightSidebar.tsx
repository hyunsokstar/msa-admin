  ...
  return (
    <aside
      className="
        ...
        space-y-2 z-50 w-36 px-1 py-2
        bg-white/90 backdrop-blur-md
        rounded-lg shadow-lg border border-white/30
      "
    >
      {/* 사이드바 제목 */}
      <div className="text-center mb-2">
        <h3 className="text-xs font-semibold text-teal-600">목차</h3>
        <div className="w-6 h-px bg-teal-300 mx-auto rounded-full mt-1"></div>
      </div>
      ...
      {sidebarOrder.map((sec) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={cn(
                'absolute left-0 top-1/2 -translate-y-1/2 w-0.5 h-3 bg-gradient-to-b from-teal-400 to-pink-400 rounded-r-full transition-all',
