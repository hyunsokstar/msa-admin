...
const fullStackItems: {
  ...
  },
  {
    ...
    description: (
      <ul className="list-disc pl-6 space-y-2 text-sm text-gray-700">
        <li>
          <strong>React / Next.js 14</strong> <br />
          CTI 관리 화면과 실시간 콜 상태 표시 등을 구현합니다.
        </li>
        <li>
          <strong>상태 관리 & 데이터 페칭</strong> <br />
          Zustand, Redux Toolkit 및 TanStack Query를 이용해 전역 상태와 서버 데이터를 효율적으로 관리합니다.
        </li>
        <li>
  ...
  },
  {
    ...
    description: (
      <>
        <p className="mb-2 font-semibold text-gray-800">네트워크를 이해해야 하는 이유:</p>
        <ul className="list-disc pl-6 space-y-2 text-sm text-gray-700">
          <li>
          ...
          <li>
            ...
            로드밸런서, 리버스 프록시, VPN, DMZ 등을 이해해 대규모 트래픽을 분산 처리하고 세션 스티키니스를 고려한 구성을 해야 합니다.
          </li>
          <li>
...
const FullStackForCTI: React.FC = () => {
  return (
    <section className="bg-white rounded-2xl shadow-md p-8 max-w-7xl mx-auto my-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {fullStackItems.map((item, idx) => (
          ...
          >
            ...
            <CardContent className="pt-2">{item.description}</CardContent>
          </Card>
        ))}
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="border border-gray-200">
            ...
            <CardContent className="pt-2 space-y-3">
              <Button
                variant="link"
                className="w-full justify-start text-blue-600 hover:underline"
                asChild
              >
              ...
              <Button
                ...
                asChild
              >
                <a href="https://www.inflearn.com/search?s=network" target="_blank" rel="noopener noreferrer">
                  Network 검색 결과
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://www.inflearn.com/search?s=canvas" target="_blank" rel="noopener noreferrer">
                  Canvas 검색 결과
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://www.inflearn.com/search?s=figma" target="_blank" rel="noopener noreferrer">
                  Figma 검색 결과
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://www.inflearn.com/search?s=java" target="_blank" rel="noopener noreferrer">
                  Java 검색 결과
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://www.inflearn.com/search?s=db" target="_blank" rel="noopener noreferrer">
                  DB 검색 결과
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://www.inflearn.com/search?s=%EB%B0%B0%ED%8F%AC" target="_blank" rel="noopener noreferrer">
                  배포 검색 결과
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://www.inflearn.com/search?s=%EC%8A%A4%ED%94%84%EB%A7%81" target="_blank" rel="noopener noreferrer">
                  스프링 검색 결과
                </a>
              </Button>
            </CardContent>
          ...
          <Card className="border border-gray-200">
            ...
            <CardContent className="pt-2 space-y-3">
              <Button
                ...
                asChild
              >
                <a href="https://fastcampus.co.kr/category_online_dgn" target="_blank" rel="noopener noreferrer">
                  디자인 강의
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://fastcampus.co.kr/category_online_bizchatgpt" target="_blank" rel="noopener noreferrer">
                  AI 생산성 강의
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://fastcampus.co.kr/category_online_aitechrag" target="_blank" rel="noopener noreferrer">
                  RAG & AI Agent 강의
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://fastcampus.co.kr/search?keyword=nest%20js%20" target="_blank" rel="noopener noreferrer">
                  NestJS 관련 강의
                </a>
              </Button>
            </CardContent>
          ...
          <Card className="border border-gray-200">
            ...
            <CardContent className="pt-2 space-y-3">
              <Button
                ...
                asChild
              >
                <a href="https://news.hada.io/" target="_blank" rel="noopener noreferrer">
                  Geek News (Hada.io)
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://news.hada.io/topic?id=18131" target="_blank" rel="noopener noreferrer">
              ...
              <Button
                ...
                asChild
              >
                <a href="https://news.hada.io/topic?id=21115" target="_blank" rel="noopener noreferrer">
                  AI 시대 개발 패턴
                </a>
              </Button>
              <Button
                ...
                asChild
              >
                <a href="https://news.hada.io/topic?id=21161" target="_blank" rel="noopener noreferrer">
