...
const ProductivityStrategies: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100" id="top">
            <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                        현대적이고 효율적인 개발 환경을 구축하여 팀의 생산성을 극대화하는 <strong>{strategies.length}가지</strong> 핵심 전략
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                    {strategies.map((item, index) => (
                        ...
                        >
                            ...
                            {/* Number Badge */}
                            <div className="absolute -top-3 -right-3 w-12 h-12 bg-gradient-to-br from-gray-800 to-gray-600 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                <span className="text-white font-bold text-sm">{item.id}</span>
                            </div>

                            <CardHeader className="pb-4">
                                <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br ${item.gradient} text-white shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300`}>
                                    {item.icon}
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <div className="pt-6">
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <p className="text-sm font-semibold text-gray-900">기대 효과</p>
                                        </div>
